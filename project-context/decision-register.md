...
- ✅ **方案 C 已授权、S0.3 连通检查已通过、模型修订为 deepseek-v4-flash**（2026-08-13 授权 + 2026-08-14 修订与检查通过）：DeepSeek `deepseek-v4-flash`、≤100 次/≤10 元；**#21 合入前禁止运行 C；A/B 已候选级停止，不得继续调参或缩小验收**；见 D-T006-R3-C-EXT、D-T006-R3-SPIKE 执行进展；
