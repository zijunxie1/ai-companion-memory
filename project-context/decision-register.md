...
- ✅ **Founder 2026-08-15 选择 A（R4 方向）**：停止"孤立记忆打分 + 单一阈值"路线，转向"上下文记忆可用性判断"（D-1 核心方向 + D-3 输出方式 + D-4 安全要求；D-2/D-5 暂缓）；R4 DRAFT 待审批、独立分支、不得混入 R3 收尾；见 D-T006-R4-DIRECTION；
