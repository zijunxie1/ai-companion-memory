...
| 引用 | Commit | 说明 |
|---|---|---|
| GitHub 默认分支 `origin/main` | `855f16b` | 含 TASK-002 历史，不含 TASK-003 合并链 |
| 远端 `origin/master` | `064f5b6` | 含 TASK-003 `0403107` 及文档路径修复 |
| 分叉 | `11 / 29` | `origin/main` 和 `origin/master` 双方均有独有提交 |

因此，“TASK-003 MERGED”当前只能表述为“已进入远端 master”，不能表述为“默认主线已经收敛”。禁止 force push、删除分支或在未裁决前继续把新功能提交到任一假定主线。
